...
const Pagination = ({ totalPage, page, limits, siblings, handlePageChange }: PaginationProps) => {
    ...
    <PaginationWrapper>
      ...
      <PaginationContainer>
        <PaginationArrowButton onClick={() => handlePageChange('prev')}>
          ...
          <SVGmodifier svg={'/assets/icons/left.svg'} width={17} height={17} stroke="white" />
        </PaginationArrowButton>
        ...
        <PaginationArrowButton onClick={() => handlePageChange('next')}>
          {' '}
          <SVGmodifier svg={'/assets/icons/right.svg'} width={17} height={17} stroke="white" />
        </PaginationArrowButton>
      </PaginationContainer>
    </PaginationWrapper>
  );
